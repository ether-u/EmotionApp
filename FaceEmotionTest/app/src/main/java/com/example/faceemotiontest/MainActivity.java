...
public class MainActivity extends AppCompatActivity {
    ...
    Button buttonhappy,getemotionbutton,buttonNegative,buttongetImage,buttontakeImage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        //This page is linked to mainactivity.java

        // hold our image view and text view
        imageView = findViewById(R.id.imageView);
        resultText = findViewById(R.id.resultText);
        buttonhappy=findViewById(R.id.buttonPositive);
        getemotionbutton=findViewById(R.id.getEmotion);
        buttonNegative=findViewById(R.id.buttonNegative);
        buttongetImage=findViewById(R.id.getImage);
        buttontakeImage=findViewById(R.id.getCameraImage);
